...
let Dict = [
    ...
    "NI2E", "Empty Insulin", "אם הוזרק אתמול בערב אינסולין ארוך-טווח - בבקשה לציין כמה. אם לא - בבקשה להשאיר ריק.",
    "NI2L", "lowDose", "כאן מציינים כמה אינסולין ארוך-טווח הוזרק אתמול בערב (אם לא הוזרק - בבקשה להשאיר ריק)",
    "NI2M", "mediumDose", "כאן מציינים כמה אינסולין ארוך-טווח הוזרק אתמול בערב (זהו מינון מעט גבוה, בבקשה לודא שלא נרשם בטעות)",
    "NI2H", "HighDose", "כאן מציינים כמה אינסולין ארוך-טווח הוזרק אתמול בערב (זהו מינון <i><b>מאד</b></i> גבוה, חשוב לודא שלא נרשם בטעות)",
];
...
function colorCode(e) {
    ...
    let ranger = 'input[type="range"]#' + e.id;
    style.innerHTML = ranger + '::-webkit-slider-thumb { border-color:' + cC + '}\n'+
                      ranger + '::-ms-thumb { border-color:' + cC + '}\n'+
                      ranger + '::-moz-range-thumb { border-color:' + cC + '}';
}
