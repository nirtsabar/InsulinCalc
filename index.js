...
let Dict = [
    ...
    "NG0","EmptySugar","אם לא נמדד גלוקוז (סוכר) הבוקר - יש להשאיר ריק. אם כן נמדד, בבקשה לציין התוצאה. (כך נוכל להתאים מינון אינסולין ארוך-טווח)",
    "NG0","Hypo","זהירות! זוהי רמת סוכר נמוכה באופן מסוכן. יש לתת בזהירות שתיה עם סוכר ולפנות לרופא. חשוב גם להפחית או להפסיק אינסולין ארוך-טווח",
    "NG0","Low","זוהי רמת סוכר נמוכה מדי לטיפול באינסולין. לכן נפחית מינון אינסולין ארוך-טווח",
    "NG0","Optimal","זוהי רמת סוכר מתאימה לטיפול באינסולין ארוך-טווח - במינון של אתמול. (אם יש צורך לרדת במשקל ניתן להפחית צריכת פחמימות במקביל להפחתת מינון)",
    "NG0","High","זוהי רמת סוכר גבוהה. לפני עליה במינון - חשוב לוודא שהמדידה נעשתה בצום, ששתיית המים בכמות טובה (בד''כ 1.5-2.5 ליטרים ביממה), שהופחתו פחמימות ומתוקים מהמזון והשתיה (אלא אם נדרשת עליה במשקל) ושאין זיהום, אלכוהול, עישון או תרופה עודפת הגורמת עליית סוכר. אם זה המצב, נעלה מינון אינסולין ארוך-טווח",
    "NG0","VeryHigh","זוהי רמת סוכר גבוהה באופן מסוכן. יש לפנות לרופא באופן מיידי. בינתיים - רצוי לשתות מים (בזהירות)",
    "NI0","EmptyInsulin","אם הוזרק אתמול בבוקר אינסולין קצר-טווח - בבקשה לציין כמה. אם לא - בבקשה להשאיר ריק.",
    "NI0","lowDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בבוקר (אם לא הוזרק - בבקשה להשאיר ריק)",
    "NI0","mediumDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בבוקר (זהו מינון מעט גבוה, בבקשה לודא שלא נרשם בטעות)",
    "NI0","HighDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בבוקר (זהו מינון <i><b>מאד</b></i> גבוה, חשוב לודא שלא נרשם בטעות)",
    "NG1","EmptySugar","אם לא נמדד גלוקוז (סוכר) אתמול לפני ארוחת צהרים - יש להשאיר ריק. אם כן נמדד, בבקשה לציין התוצאה. (כך נוכל להתאים מינון אינסולין קצר-טווח בבוקר)",
    "NG1","Hypo","זהירות! זוהי רמת סוכר נמוכה באופן מסוכן. במצב כזה יש לתת בזהירות שתיה עם סוכר ולפנות לרופא. חשוב גם להפחית או להפסיק אינסולין קצר-טווח בבוקר",
    "NG1","Low","זוהי רמת סוכר נמוכה מדי לטיפול באינסולין. לכן נפחית מינון אינסולין קצר-טווח בבוקר",
    "NG1","Optimal","זוהי רמת סוכר מתאימה לטיפול באינסולין קצר-טווח - במינון של אתמול בבוקר. (אם יש צורך לרדת במשקל ניתן להפחית צריכת פחמימות במקביל להפחתת מינון)",
    "NG1","High","זוהי רמת סוכר גבוהה. לפני עליה במינון - חשוב לוודא שהמדידה נעשתה לפני הארוחה, ששתיית המים בכמות טובה (בד''כ 1.5-2.5 ליטרים ביממה), שהופחתו פחמימות ומתוקים מהמזון והשתיה (אלא אם נדרשת עליה במשקל) ושאין זיהום, אלכוהול, עישון או תרופה עודפת הגורמת עליית סוכר. אם זה המצב, נעלה מינון אינסולין קצר-טווח בבוקר",
    "NG1","VeryHigh","זוהי רמת סוכר גבוהה באופן מסוכן הדורשת פניה מיידית לרופא.",
    "NI1","EmptyInsulin","אם הוזרק אתמול בצהרים אינסולין קצר-טווח - בבקשה לציין כמה. אם לא - בבקשה להשאיר ריק.",
    "NI1","lowDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בצהרים (אם לא הוזרק - בבקשה להשאיר ריק)",
    "NI1","mediumDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בצהרים (זהו מינון מעט גבוה, בבקשה לודא שלא נרשם בטעות)",
    "NI1","HighDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בצהרים (זהו מינון <i><b>מאד</b></i> גבוה, חשוב לודא שלא נרשם בטעות)",
    "NG2","EmptySugar","אם לא נמדד גלוקוז (סוכר) אתמול לפני ארוחת ערב - יש להשאיר ריק. אם כן נמדד, בבקשה לציין התוצאה. (כך נוכל להתאים מינון אינסולין קצר-טווח בצהרים)",
    "NG2","Hypo","זהירות! זוהי רמת סוכר נמוכה באופן מסוכן. במצב כזה יש לתת בזהירות שתיה עם סוכר ולפנות לרופא. חשוב גם להפחית או להפסיק אינסולין קצר-טווח בצהרים",
    "NG2","Low","זוהי רמת סוכר נמוכה מדי לטיפול באינסולין. לכן נפחית מינון אינסולין קצר-טווח בצהרים",
    "NG2","Optimal","זוהי רמת סוכר מתאימה לטיפול באינסולין קצר-טווח - במינון של אתמול בצהרים. (אם יש צורך לרדת במשקל ניתן להפחית צריכת פחמימות במקביל להפחתת מינון)",
    "NG2","High","זוהי רמת סוכר גבוהה. לפני עליה במינון - חשוב לוודא שהמדידה נעשתה לפני הארוחה, ששתיית המים בכמות טובה (בד''כ 1.5-2.5 ליטרים ביממה), שהופחתו פחמימות ומתוקים מהמזון והשתיה (אלא אם נדרשת עליה במשקל) ושאין זיהום, אלכוהול, עישון או תרופה עודפת הגורמת עליית סוכר. אם זה המצב, נעלה מינון אינסולין קצר-טווח בצהרים",
    "NG2","VeryHigh","זוהי רמת סוכר גבוהה באופן מסוכן הדורשת פניה מיידית לרופא.",
    "NI2","EmptyInsulin","אם הוזרק אתמול בערב אינסולין קצר-טווח - בבקשה לציין כמה. אם לא - בבקשה להשאיר ריק.",
    "NI2","lowDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בערב (אם לא הוזרק - בבקשה להשאיר ריק)",
    "NI2","mediumDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בערב (זהו מינון מעט גבוה, בבקשה לודא שלא נרשם בטעות)",
    "NI2","HighDose","כאן מציינים כמה אינסולין קצר-טווח הוזרק אתמול בערב (זהו מינון <i><b>מאד</b></i> גבוה, חשוב לודא שלא נרשם בטעות)",
];
